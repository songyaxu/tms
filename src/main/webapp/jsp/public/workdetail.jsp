...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">作业详情</strong> / <small>detail</small></div>
  </div>
  ...
  <div class="am-tabs am-margin" data-am-tabs>
    ...
    <div class="am-tabs-bd">
      <div class="am-tab-panel am-fade am-in am-active" id="tab1">
        <form class="am-form">
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-4">
              <input type="text" class="am-input-sm" id="title" readonly="readonly" value="${work.title}"> 
            </div>
          ...
          <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-10">
              <textarea rows="10" placeholder="" id="content" readonly="readonly">${work.content}</textarea>
            </div>
          </div>
      ...
      <div class="am-tab-panel am-fade" id="tab2">
         <div class="am-u-md-8">
         	<c:if test="${work.attachment==null or work.attachment=='' }">
         		<p>无附件</p>
         	</c:if>
           <form class="am-form" id="uploadForm">
             <div class="am-form-group">
             	<c:if test="${work.attachment!=null and work.attachment!=''}">
		               <p class="am-form-help">${work.title }-附件</p>
      ...
      <div class="am-tab-panel am-fade" id="tab3">
        <form class="am-form">
          <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-10">
              <textarea rows="10" placeholder="" id="description" readonly="readonly">${work.description }</textarea>
            </div>
          </div>
          </form>
          </div>

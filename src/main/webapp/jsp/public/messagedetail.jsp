...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">邮件详情</strong> / <small>Message Detail</small></div>
    </div>
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
         <form class="am-form am-form-horizontal" id="updateForm">
          ...
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">发件人ID</label>
            <div class="am-u-sm-9">
              <input type="text" id="sendId" name="sendId" value="${msg.sendId}" readonly="readonly"/>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="receiveId" name="receiveId" value="${msg.receiveId}" readonly="readonly">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea rows="10"  readonly="readonly">${msg.content}</textarea>
            </div>
          </div>
		  <div class="am-form-group">
            <label for="userphone" class="am-u-sm-3 am-form-label">读取状态</label>
            <div class="am-u-sm-9">
              <input type="text"  value="${msg.state eq 0 ?"未读":"已读"}" readonly="readonly">
            </div>
          </div>
		  <div class="am-form-group">
            <label for="userphone" class="am-u-sm-3 am-form-label">发送时间</label>
            <div class="am-u-sm-9">
              <input type="text"  value="${msg.sendTime}" readonly="readonly">
            </div>
          </div>

          <c:if test="${msg.type== 2 }">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">动作结果:    </label>
            <div class="am-u-sm-9">
            	<input type="text" readonly="readonly" value="${msg.result}">
            </div>
          </div>
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">响应时间:    </label>
            <div class="am-u-sm-9">
            	<input type="text"  value="${msg.actionTime}" readonly="readonly">
            </div>
          </div>
          </c:if>
          <c:if test="${msg.type== 2 && msg.receiveId==user.id && msg.action==0}">
	          	<div class="am-form-group">
	            <div class="am-u-sm-9 am-u-sm-push-3">
	              <button type="button" class="am-btn am-btn-success" onclick="javascript:approval(1);">通过</button>
	              <button type="button" class="am-btn am-btn-danger" onclick="javascript:approval(0);">拒绝</button>
	            </div>
          </div>
          </c:if>
        </form>
...
<script type="text/javascript">
	function approval(type) {  
		 var id = $("#id").val();
	     $.ajax({  
	          url: '${pageContext.request.contextPath}/group/approval/'+id ,
	          data:{type:type}, 
	          type: 'POST',  

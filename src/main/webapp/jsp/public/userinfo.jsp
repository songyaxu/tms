      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" id="updateForm">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="id" name="id" value="${targetUser.id}" readonly="readonly"/>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="name" name="name"  value="${targetUser.name}" readonly="readonly">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="email" name="email" placeholder="输入你的电子邮件 "  value="${targetUser.email}" readonly="readonly">
            </div>
          </div>
		  ...
		  <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="phone" name="phone" value="${targetUser.phone}" readonly="readonly">
            </div>
          </div>
		  <c:if test="${targetUser.type==0}">
			  <div class="am-form-group">
	            <label for="userphone" class="am-u-sm-3 am-form-label">院/系</label>
	            <div class="am-u-sm-9">
	              <input type="text" id="dept" name="dept" value="${targetUser.dept}" readonly="readonly">
	            </div>
	          </div>
			  ...
			  <div class="am-form-group">
	            ...
	            <div class="am-u-sm-9">
	              <input type="text" id="major"  name="major" value="${targetUser.major}" readonly="readonly">
	            </div>
	          </div>
		  </c:if>
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class="" rows="5" id="resume"  name="resume" readonly="readonly">${targetUser.resume}</textarea>
            </div>
          </div>
        </form>
      </div>

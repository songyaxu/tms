...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">提交作业</strong> / <small>submit</small></div>
  </div>
  ...
  <div class="am-tabs am-margin" data-am-tabs>
    ...
    <div class="am-tabs-bd">
      ...
      <div class="am-tab-panel">
      	<c:if test="${groupWork!=null}">
	      	 <c:if test="${groupWork.attachment=='' or groupWork.attachment==null}">
	         <div class="am-u-md-8">
	         ...
	         <c:if test="${groupWork.attachment!='' and groupWork.attachment!=null}">
	         	已经提交作业！无法重复提交。
	         </c:if>
         </c:if>
         <c:if test="${groupWork==null}">
	...
	<c:if test="${groupWork!=null}">
	      	 <c:if test="${groupWork.attachment==''}">
  <div class="am-margin">
...
function publish(){
	...
	if(attachment==="")
	{
		layer.msg("上传文件",{icon: 5});
		return;
	}
   	$.get("${pageContext.request.contextPath}/groupwork/update/"+${groupWork.id},

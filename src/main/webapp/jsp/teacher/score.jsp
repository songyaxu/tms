...
<div class="admin-content">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">作业审批</strong> / <small>approval</small></div>
  </div>
        ...
        <form class="am-form">
          ...
          <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-10">
              <textarea rows="10" placeholder="" id="comment"></textarea>
            </div>
          </div>
  ...
  <div class="am-margin">
    <button type="button" class="am-btn am-btn-primary am-btn-xs" onclick="javascript:score();">提交保存</button>
...
function score(){
	...
	if(score==="")
	{
		layer.msg("请输入作业得分",{icon: 5});
		return;
	}
	if(comment==="")
	{
		layer.msg("请输入作业评语",{icon: 5});
		return;
	}
   	$.get("${pageContext.request.contextPath}/groupwork/score/"+${id},

      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-id">#</th><th class="table-title">ID</th><th class="table-type">作者</th><th class="table-author">标题</th><th class="table-date">发布时间</th><th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
            <c:forEach var="obj" items="${myProjectList}" varStatus="status">
          <tr>
          	<td>${status.index+1}</td><td>${obj.id }</td><td>${obj.userName}</td><td><a href="javascript:detail(${obj.id})">${obj.title}</a></td><td>${obj.time }</td>
            <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    ...
                    <button class="am-btn am-btn-default am-btn-xs" onclick="javascript:setWork(${obj.id})"><span class="am-icon-flag-o"></span>布置作业</button>
                  </div>
                </div>
              </td>
          </tr>
